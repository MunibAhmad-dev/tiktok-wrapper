  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            background: 'linear-gradient(135deg, #25F4EE 0%, #FE2C55 60%, #010101 100%)',
        ...
        <div style={{ padding: '28px 32px 32px' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              ...
              className="w-full"
              style={{
                background: 'linear-gradient(135deg, #FE2C55 0%, #E0234A 100%)',
                color: '#fff',
                borderRadius: '8px',
                fontWeight: 600,
                fontSize: '15px',
          ...
          <div style={{ textAlign: 'center', marginTop: '16px' }}>
            <Button
              ...
              style={{ color: '#FE2C55', fontWeight: 500, fontSize: '13px' }}
            >
              {isRegisterMode
          ...
          >
            Not affiliated with TikTok Inc.
          </p>
        </div>
      </div>
    </div>
