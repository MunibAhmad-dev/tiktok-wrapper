...
export function ContentStudioPanel() {
  ...
  return (
    <PremiumGate
      ...
      description="Generate scroll-stopping captions and trending hashtags for your TikTok posts in seconds."
      icon="✨"
    >
      <div className="flex flex-col h-full">
        ...
        >
          <div
            className="w-8 h-8 rounded-xl bg-[#FE2C55]/10 dark:bg-[#FE2C55]/15 flex items-center justify-center text-[#FE2C55]"
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {hashtags.map((tag) => (
                    <button
                      ...
                      title="Click to copy"
                      className="px-2 py-0.5 rounded-full bg-[#FE2C55]/10 text-[#FE2C55] border border-[#FE2C55]/30 text-[11px] font-semibold hover:bg-[#FE2C55]/20 transition-colors"
                    >
                      {tag}
                    </button>
                  ))}
          ...
          <p className="text-[11px] text-muted-foreground text-center">
            Powered by GPT-4o-mini · Tailored for TikTok
          </p>
        </div>
      </div>
    </PremiumGate>
