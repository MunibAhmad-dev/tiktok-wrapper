                ...
                {activeTab === 'accounts' && (
                  <div className="space-y-3">
                    ...
                    {!isPremium && visibleAccounts.length >= 1 && (
                      <div className="rounded-2xl bg-[#FE2C55]/10 dark:bg-[#FE2C55]/15 border border-[#FE2C55]/30 dark:border-[#FE2C55]/40 p-4 flex items-start gap-3">
                ...
                {activeTab === 'about' && (
                  <div className="space-y-5">
                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-muted/30 border border-border/40">
                      <img src={logoUrl} alt="App" className="w-14 h-14 rounded-2xl object-cover shadow-md shrink-0" />
                      <div>
                        <p className="text-base font-bold text-foreground">Apps for TikTok</p>
                        <p
                    ...
                    <p className="text-[11px] text-muted-foreground text-center leading-relaxed">
                      Not affiliated with TikTok Inc. TikTok® is a trademark of TikTok Inc. This app is an independent productivity tool.
                    </p>
        ...
        <div className="flex items-center gap-2">
          ...
          {!isPremium && (
            <button
              ...
              className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-[#FE2C55]/10 dark:bg-[#FE2C55]/15 border border-[#FE2C55]/30 dark:border-[#FE2C55]/40 text-[#FE2C55] dark:text-[#FE2C55] text-[9px] font-bold hover:bg-[#FE2C55]/20 dark:hover:bg-[#FE2C55]/25 transition-colors"
            >
...
function SettingsTabGate({ icon, title, description, features, onUpgrade }: {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full py-6 px-4 text-center">
      ...
      {/* Lock badge */}
      <div className="flex items-center gap-1.5 bg-[#FE2C55]/10 dark:bg-[#FE2C55]/15 border border-[#FE2C55]/30 dark:border-[#FE2C55]/40 text-[#FE2C55] dark:text-[#FE2C55] px-3 py-1 rounded-full text-xs font-bold mb-3">
      ...
      <ul className="space-y-1.5 mb-6 text-left w-full max-w-xs">
        {features.map(f => (
          <li key={f} className="flex items-center gap-2 text-sm text-foreground/80">
            <div className="w-4 h-4 rounded-full bg-[#FE2C55]/10 dark:bg-[#FE2C55]/15 flex items-center justify-center shrink-0">
              <Sparkles className="h-2.5 w-2.5 text-[#FE2C55] dark:text-[#FE2C55]" />
            </div>
            {f}
          </li>
        ))}
      ...
      <Button
        onClick={onUpgrade}
        className="gap-2 bg-[#FE2C55] hover:bg-[#E0234A] text-white border-none"
      >
