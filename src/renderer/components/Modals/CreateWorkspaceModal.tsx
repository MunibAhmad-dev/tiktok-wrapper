  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (workspace) {
        ...
        const account = await window.electronAPI?.workspaceAccount.add(workspace.id, 'TikTok Account')
    ...
    <Dialog open={isCreateWorkspaceModalOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[460px] overflow-y-auto max-h-[90vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Organize your TikTok accounts within a customized, premium workspace.
          </DialogDescription>
        </DialogHeader>
