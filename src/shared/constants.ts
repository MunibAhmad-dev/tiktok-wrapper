export const APP_NAME = "Apps for TikTok";
...
export const MESSENGER_URL = "https://www.tiktok.com/messages";
...
export const FACEBOOK_NOTIFICATIONS_URL = "https://www.tiktok.com/messages";
...
export const PREMIUM_FEATURE_LIST = [
  { icon: '🤖', title: 'AI Reply Assistant',   desc: 'Generate smart replies with adjustable tone',    view: 'ai-reply'            },
  { icon: '✍️',  title: 'Quick Reply',          desc: 'Compose replies natively, paste into chat',      view: 'quick-reply'         },
  { icon: '🌐', title: 'Translation',           desc: 'Translate into 14 languages instantly',          view: 'translate'           },
  { icon: '✨', title: 'AI Post Studio',         desc: 'Generate post captions & trending hashtags',     view: 'content'             },
  { icon: '📅', title: 'Message Scheduler',     desc: 'Plan messages and get reminded to send them',    view: 'scheduler'           },
  { icon: '🎯', title: 'Focus Mode',            desc: 'Scheduled Do Not Disturb sessions',              view: 'focus'               },
  { icon: '🔍', title: 'Smart Filters',         desc: 'Filter accounts by creator type or flag',        view: 'filters'             },
  { icon: '📊', title: 'Analytics',             desc: 'Track DM activity across your accounts',         view: 'analytics'           },
  ...
  { icon: '💼', title: 'Multiple Accounts',     desc: 'Add unlimited TikTok accounts',                  view: 'messaging'           },
...
// User-agent pretending to be Safari for best TikTok compatibility
